...
const _sfc_main = {
  ...
  setup(__props) {
    const event = [
      {
        title: "Tix",
        description: "Tix er en norsk rapper og l\xE5tskriver fra B\xE6rum. Han er kjent for l\xE5ter som \xABShotgun\xBB, \xABNeste Sommer\xBB, \xABJeg Vil Ikke Leve\xBB, \xABKaller P\xE5 Deg\xBB og \xABJeg Vil Ikke Danse\xBB.",
        imageUrl: "/tix.svg",
...
//# sourceMappingURL=_eventName_-984fc640.mjs.map
