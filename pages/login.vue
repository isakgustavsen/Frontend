  ...
  <div class="flex min-h-full flex-1 flex-col justify-center py-12 sm:px-6 lg:px-8">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
        ...
        <form class="space-y-6" @submit.prevent="signIn">
          ...
          <div class="flex items-center justify-between">
            ...
            <div class="text-sm leading-6">
              <NuxtLink to="/resetPassword" class="font-semibold text-indigo-600 hover:text-indigo-500">Forgot password?</NuxtLink>
            </div>
          </div>
        ...
        <div>
          <div class="relative mt-10">
            ...
            <div class="relative flex justify-center text-sm font-medium leading-6">
              <span class="bg-slate-800 px-6 text-gray-200">Or continue with</span>
            </div>
          </div>

          <div class="mt-4 ">
            <NuxtLink href="#" class="flex justify-items-center justify-center gap-3 rounded-md px-3 py-1.5 text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#24292F]">
              <button class="flex justify-center rounded-md bg-indigo-600 px-6 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Passwordless</button>
            </NuxtLink>
          </div>
        </div>
      </div>
      ...
      <p class="mt-10 text-center text-sm text-gray-500">
        Not a member?
        {{ ' ' }}
        <NuxtLink to="/register"  class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">Start a 14 day free trial</NuxtLink>
      </p>
    </div>
  </div>
</template>