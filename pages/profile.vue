        ...
        <form>
            <div class="space-y-12">
                <div class="border-b border-white/10 pb-12">
                    <h2 class="text-base font-semibold leading-7 text-white">Personal info</h2>
                    ...
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="sm:col-span-4">
                            <label for="email" type="email" class="block text-sm font-medium leading-6 text-white">Email address</label>
                            <div class="mt-2">
...
<!-- About you -->
                <div class="border-b border-white/10 pb-12">
                    <h2 class="text-base font-semibold leading-7 text-white">About You</h2>
                    <p class="mt-1 text-sm leading-6 text-gray-400">Tell your group about yourself.</p>
                ...
                <!-- Study -->
                <div class="border-b border-white/10 pb-12">
                    <h2 class="text-base font-semibold leading-7 text-white">Study</h2>
                    <p class="mt-1 text-sm leading-6 text-gray-400">Tell your group about yourself.</p>
...
<!-- Notifications -->
                <div class="border-b border-white/10 pb-12">
                    ...
                    <p class="mt-1 text-sm leading-6 text-gray-400">We'll always let you know about important changes, but
                    ...
                    <div class="mt-10 space-y-10">
                            ...
                            <div class="mt-6 space-y-6">
                                <div class="relative flex gap-x-3">
                                    ...
                                    <div class="text-sm leading-6">
                                        ...
                                        <p class="text-gray-400">Get notified when someones posts a comment on a posting.
                                        </p>
                                    </div>
                                </div>
                                <div class="relative flex gap-x-3">
                                ...
                                <div class="relative flex gap-x-3">
                                    ...
                                    <div class="text-sm leading-6">
                                        ...
                                        <p class="text-gray-400">Get notified when a candidate accepts or rejects an offer.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <fieldset>
                            ...
                            <p class="mt-1 text-sm leading-6 text-gray-400">These are delivered via SMS to your mobile
                                phone.</p>
                            <div class="mt-6 space-y-6">
                                ...
                                <label for="push-everything"
                                    class="block text-sm font-medium leading-6 text-white">Everything</label>
                            </div>
                            <div class="flex items-center gap-x-3">
                                <input id="push-email" name="push-notifications" type="radio"
                                    class="h-4 w-4 border-white/10 bg-white/5 text-indigo-600 focus:ring-indigo-600 focus:ring-offset-gray-900" />
                                <label for="push-email" class="block text-sm font-medium leading-6 text-white">Same as
                                    email</label>
                            </div>
                            <div class="flex items-center gap-x-3">
                                <input id="push-nothing" name="push-notifications" type="radio"
                                    class="h-4 w-4 border-white/10 bg-white/5 text-indigo-600 focus:ring-indigo-600 focus:ring-offset-gray-900" />
                                <label for="push-nothing" class="block text-sm font-medium leading-6 text-white">No push
                                    notifications</label>
                            </div>
                        </div>
                    </fieldset>
