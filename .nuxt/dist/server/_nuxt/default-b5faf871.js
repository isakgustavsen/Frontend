import { defineComponent, provide, shallowReactive, h, ref, inject, Suspense, nextTick, Transition, mergeProps, unref, withCtx, createVNode, openBlock, createBlock, Fragment, renderList, toDisplayString, resolveDynamicComponent, useSSRContext } from "vue";
...
const _imports_0 = "" + __buildAssetsURL("logo.77e13a85.png");
const _sfc_main = {
  __name: "default",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-slate-200 dark:bg-slate-900" }, _attrs))}><header class="bg-slate-800"><nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global"><div class="flex lg:flex-1"><a href="/" class="-m-1.5 p-1.5"><span class="sr-only">DebutUKA i Tromsø</span><img class="h-8 w-auto"${ssrRenderAttr("src", _imports_0)} alt=""></a></div><div class="flex lg:hidden"><button type="button" class="-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-gray-400"><span class="sr-only">Open main menu</span>`);
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(unref(DialogPanel), { class: "fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-gray-900 px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-white/10" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="flex items-center justify-between"${_scopeId2}><a href="#" class="-m-1.5 p-1.5"${_scopeId2}><span class="sr-only"${_scopeId2}>DebutUKA i Tromsø</span><img class="h-8 w-auto"${ssrRenderAttr("src", _imports_0)} alt=""${_scopeId2}></a><button type="button" class="-m-2.5 rounded-md p-2.5 text-gray-400"${_scopeId2}><span class="sr-only"${_scopeId2}>Close menu</span>`);
                  ...
                  return [
                    createVNode("div", { class: "flex items-center justify-between" }, [
                      createVNode("a", {
                        ...
                        createVNode("span", { class: "sr-only" }, "DebutUKA i Tromsø"),
                        createVNode("img", {
                          class: "h-8 w-auto",
                          src: _imports_0,
                          alt: ""
      ...
      _push(`<!--]--></div><p class="mt-10 text-center text-xs leading-5 text-gray-300">© 2023 DebutUKA i Tromsø All rights reserved. </p></div></footer></div>`);
    };
  }
};
...
//# sourceMappingURL=default-b5faf871.js.map
